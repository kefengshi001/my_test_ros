...
// (in-package plumbing_severe_client.srv)
...
class AddIntsRequest {
  ...
  static datatype() {
    ...
    return 'plumbing_severe_client/AddIntsRequest';
  }
...
class AddIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_severe_client/AddIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'plumbing_severe_client/AddInts'; }
};
