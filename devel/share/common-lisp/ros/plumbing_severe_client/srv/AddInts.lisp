...
(cl:in-package plumbing_severe_client-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_severe_client-srv:<AddInts-request> is deprecated: use plumbing_severe_client-srv:AddInts-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_severe_client-srv:num1-val is deprecated.  Use plumbing_severe_client-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_severe_client-srv:num2-val is deprecated.  Use plumbing_severe_client-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-request>)))
  ...
  "plumbing_severe_client/AddIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-request)))
  "Returns string type for a service object of type 'AddInts-request"
  "plumbing_severe_client/AddIntsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddInts-request>)))
  ...
  (cl:format cl:nil "#客户端请求时发送的数字~%int32 num1~%int32 num2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddInts-request)))
  "Returns full string definition for message of type 'AddInts-request"
  (cl:format cl:nil "#客户端请求时发送的数字~%int32 num1~%int32 num2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_severe_client-srv:<AddInts-response> is deprecated: use plumbing_severe_client-srv:AddInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_severe_client-srv:sum-val is deprecated.  Use plumbing_severe_client-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-response>)))
  ...
  "plumbing_severe_client/AddIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-response)))
  "Returns string type for a service object of type 'AddInts-response"
  "plumbing_severe_client/AddIntsResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddInts-response>)))
  ...
  (cl:format cl:nil "#服务器响应发送到数据~%int32 sum~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddInts-response)))
  "Returns full string definition for message of type 'AddInts-response"
  (cl:format cl:nil "#服务器响应发送到数据~%int32 sum~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts)))
  ...
  "plumbing_severe_client/AddInts")